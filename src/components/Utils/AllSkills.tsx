...
//   { id: 3, icon: skill3, name: 'JavaScript' },
//   { id: 4, icon: skill4, name: 'Git' },
//   { id: 5, icon: skill5, name: 'GitHub' },
//   { id: 6, icon: skill6, name: 'GitLab' },
//   { id: 7, icon: skill7, name: 'Bitbucket' },
//   { id: 8, icon: skill8, name: 'npm' },
//   { id: 9, icon: skill9, name: 'yarn' },
//   { id: 10, icon: skill10, name: 'BEM' },
//   { id: 11, icon: skill11, name: 'OOCSS' },
//   { id: 12, icon: skill12, name: 'SMACSS' },
//   { id: 13, icon: skill13, name: 'Sass' },
//   { id: 14, icon: skill14, name: 'PostCSS' },
//   { id: 15, icon: skill15, name: 'Less' },
//   { id: 16, icon: skill16, name: 'npm scripts' },
//   { id: 17, icon: skill17, name: 'Webpack' },
//   { id: 18, icon: skill18, name: 'esbuild' },
//   { id: 19, icon: skill19, name: 'Rollup' },
//   { id: 20, icon: skill20, name: 'Parcel' },
//   { id: 21, icon: skill21, name: 'Vite' },
//   { id: 22, icon: skill22, name: 'Styled Components' },
//   { id: 23, icon: skill23, name: 'CSS Modules' },
//   { id: 24, icon: skill24, name: 'Styled JSX' },
//   { id: 25, icon: skill25, name: 'Emotion' },
//   { id: 26, icon: skill26, name: 'React' },
//   { id: 27, icon: skill27, name: 'Redux' },
//   { id: 28, icon: skill28, name: 'MobX' },
//   { id: 29, icon: skill29, name: 'Recoil' },
//   { id: 30, icon: skill30, name: 'Angular' },
//   { id: 31, icon: skill31, name: 'RxJS' },
//   { id: 32, icon: skill32, name: 'NgRx' },
//   { id: 33, icon: skill33, name: 'Vue.js' },
//   { id: 34, icon: skill34, name: 'VueX' },
//   { id: 35, icon: skill35, name: 'Bootstrap' },
//   { id: 36, icon: skill36, name: 'Bulma' },
//   { id: 37, icon: skill37, name: 'Tailwind CSS' },
//   { id: 38, icon: skill38, name: 'Chakra UI' },
//   { id: 39, icon: skill39, name: 'Material UI' },
//   { id: 40, icon: skill40, name: 'Radix UI' },
//   { id: 41, icon: skill41, name: 'Jest' },
//   { id: 42, icon: skill42, name: 'react-testing-library' },
//   { id: 43, icon: skill43, name: 'Cypress' },
//   { id: 44, icon: skill44, name: 'Enzyme' },
//   { id: 45, icon: skill45, name: 'Mocha' },
//   { id: 46, icon: skill46, name: 'Chai' },
//   { id: 47, icon: skill47, name: 'Ava' },
//   { id: 48, icon: skill48, name: 'Jasmine' },
//   { id: 49, icon: skill49, name: 'TypeScript' },
//   { id: 50, icon: skill50, name: 'Flow' },
//   { id: 51, icon: skill51, name: 'Next.js' },
//   { id: 52, icon: skill52, name: 'After.js' },
//   { id: 53, icon: skill53, name: 'Universal' },
//   { id: 54, icon: skill54, name: 'Nuxt.js' },
//   { id: 55, icon: skill55, name: 'GraphQL' },
//   { id: 56, icon: skill56, name: 'Apollo' },
//   { id: 57, icon: skill57, name: 'Relay Modern' },
//   { id: 58, icon: skill58, name: 'GatsbyJS' },
//   { id: 59, icon: skill59, name: 'Vuepress' },
//   { id: 60, icon: skill60, name: 'Jekyll' },
//   { id: 61, icon: skill61, name: 'Hugo' },
//   { id: 62, icon: skill62, name: 'Gridsome' },
//   { id: 63, icon: skill63, name: 'Eleventy' },
//   { id: 64, icon: skill64, name: 'React Native' },
//   { id: 65, icon: skill65, name: 'NativeScript' },
//   { id: 66, icon: skill66, name: 'Flutter' },
